...
//	}
	...
	//BgtCD(coCd=1000, bgtCd=11111000, parentCd=, gisu=0, bgtNm=애기리퍼만세, divFg=, defNm=, ctlFg=null, bgajustFg=null, toDt=Thu Aug 10 09:18:36 KST 2023, bottomFg=null, bizFg=null, groupCd=, grFg=, insertId=ashtal, insertDt=Thu Aug 10 09:18:40 KST 2023, insertIp=, modifyId=, modifyDt=Thu Aug 10 09:18:40 KST 2023, modifyIp=, MultiCk=0, MultiNum=0, dataPath=수입,장,관,항,세항,목  , keyword=, bgtGrNm=, divCd=0, carrAm=0)
	// 넣을꺼 parentCd, divFg , ctlFg o , bgajustFg o  , toDt o, bottomFg o , bizFg o , groupcd,       grFg ,dataPath  // parentcd , divfg, groupcd ,grfg, datapath
	/*null 값들 초기값 부여*/
	...
	System.out.println(bgtCD.toString());
	/*
	 * BgtCD(coCd=1000, bgtCd=11121000, parentCd=11121000, gisu=0,
	 *  bgtNm=마지막 테스트야, divFg=5, defNm=, ctlFg=0, bgajustFg=0, toDt=Thu Aug 10 13:03:28 KST 2023, 
	 *  bottomFg=1, bizFg=0, groupCd=, grFg=0, insertId=ashtal, insertDt=Thu Aug 10 13:03:40 KST 2023, 
	 *  insertIp=, modifyId=, modifyDt=Thu Aug 10 13:03:40 KST 2023, modifyIp=, MultiCk=0, MultiNum=0,
	 *   dataPath=10000000,11000000,11100000,11120000,11121000,, keyword=, bgtGrNm=, divCd=0, carrAm=0)
	 *   
	 *   
	 *   
	 *   INSERT INTO BGTCD
		(CO_CD, BGT_CD,parentCd, GISU, BGT_NM, DIV_FG, CTL_FG, BGAJUST_FG, TO_DT, BOTTOM_FG, BIZ_FG, GROUP_CD, GR_FG, INSERT_ID,INSERT_DT, INSERT_IP, MODIFY_ID, MODIFY_DT, MODIFY_IP,Multi_Ck,Multi_Num,dataPath)
		VALUES 
...
BgtCD(coCd=1000, bgtCd=11210000, parentCd=11210000, gisu=0, bgtNm=변경가자!!!!, divFg=4, defNm=, ctlFg=0, bgajustFg=0, toDt=Thu Aug 10 13:14:24 KST 2023, bottomFg=1, bizFg=0, groupCd=, grFg=0, insertId=ashtal, insertDt=Thu Aug 10 13:14:31 KST 2023, insertIp=, modifyId=, modifyDt=Thu Aug 10 13:14:31 KST 2023, modifyIp=, MultiCk=0, MultiNum=0, dataPath=10000000,11000000,11200000,11210000,, keyword=, bgtGrNm=, divCd=0, carrAm=0)
